...
<img width="301.5" height="655.5" alt="Simulator Screenshot - iPhone 17 - 2026-08-01 at 22 37 01" src="https://github.com/user-attachments/assets/f4b0f243-52ab-4630-8711-4ffa16abf693" /> <br>

- **Søk (Search):** Lets the user search for recipes. The recipes are fetched from the **"TheMealDB.com"** API. The user may search for recipes based on the recipe name, country, category or ingredient. The user can also click on a recipe to see further detail, and save the recipe to favorites by swiping to the left using the "touchscreen". The recipe is then saved to the database.

<table>
  <tr>
    <td>
  <img width="301.5" height="655.5" alt="Simulator Screenshot - iPhone 17 - 2026-03-19 at 17 38 34" src="https://github.com/user-attachments/assets/5822a552-6ce1-4e34-95df-9881ad3ef250" />
</td>
  <td>
    <img width="301.5" height="655.5" alt="Simulator Screenshot - iPhone 17 - 2026-08-01 at 22 37 47" src="https://github.com/user-attachments/assets/cd481945-1254-4ec1-b8d0-674e22f3ae40" />
  </td>
</tr>
</table>
...
<img width="301.5" height="655.5" alt="Simulator Screenshot - iPhone 17 - 2026-08-01 at 22 37 59" src="https://github.com/user-attachments/assets/9bd90259-d992-40d4-b402-92ce52d34251" />
